...
class BiFPN(nn.Module):
    def __init__(self, fpn_sizes):
        ...
        self.p6_td_conv_2 = nn.Conv2d(self.W_bifpn, self.W_bifpn, kernel_size=3, stride=1, groups=self.W_bifpn,
                                      bias=True, padding=1)
        ...
        self.p7_out_conv_2 = nn.Conv2d(self.W_bifpn, self.W_bifpn, kernel_size=3, stride=1, groups=self.W_bifpn,
                                       bias=True, padding=1)
    ...
    def forward(self, inputs):
        ...
        P4_out = self.p4_out_conv((self.p4_out_w1 * P4_td_inp + self.p4_out_w2 * P4_td + self.p4_out_w3 * P3_out)
        ...
        P7_out = self.p7_out_conv_2((self.p7_out_w1 * P7_td + self.p7_out_w2 * self.p6_downsample(P6_out)) /
